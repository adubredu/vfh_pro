...
class GraspingClient(object):
    ...
    def getTargetObject(self,name):
        ...
        return obj #goalpose.object, goalpose.grasps 
...
if __name__=='__main__':
    ...
    head_action.look_at(-1,0,0., "map")
    # head_action.look_at(1.1, -0.1, 0.5,"map")
    # '''
    # Get block to pick
    # while not rospy.is_shutdown():
    #     rospy.loginfo("Picking object...")
    #     grasping_client.updateScene()
    #     cube, grasps = grasping_client.getTargetObject('blue')
    #     if cube == None:
    ...
    # grasping_client.updateScene()
    grasping_client.open_or_close_gripper('open')
    cube = grasping_client.getTargetObject('blue')
    quat = quaternion_from_euler(ai=0.0, aj=1.57, ak=0.0)
    cube.orientation.x = quat[0]
    cube.orientation.y = quat[1]
    cube.orientation.z = quat[2]
    cube.orientation.w = quat[3]
    print(cube)
    grasping_client.move_arm_to_pregrasp()
 
    grasping_client.move_arm_to_position(cube)
    grasping_client.open_or_close_gripper('close')


    # Tuck the arm
    grasping_client.raise_arm(cube)
