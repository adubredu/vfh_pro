...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/root/ros_ws/src/velodyne_simulator/velodyne_gazebo_plugins/include".split(';') if "/root/ros_ws/src/velodyne_simulator/velodyne_gazebo_plugins/include" != "" else []
